      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-lg font-semibold text-white">OurNotes</span>
            </div>

            <p className="text-gray-400 mb-6 max-w-md">
            OurNotes is a secure and collaborative note-taking and file management platform designed for modern teams and individuals.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-zinc-800">
          <p className="text-sm text-gray-400 order-2 md:order-1 mt-4 md:mt-0">
            © {new Date().getFullYear()} OurNotes. All rights reserved.
          </p>
