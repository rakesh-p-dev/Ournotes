        ...
        <div className="relative flex flex-col items-center justify-center gap-8 py-0 lg:py-10">
          ...
          <div className="flex flex-row gap-3">
              ...
              <Button
                size="lg"
                disabled
                className="gap-4 border-2 border-black bg-white text-black shadow-[4px_4px_0px_0px_#000] opacity-50 cursor-not-allowed dark:border-white/20 dark:bg-zinc-900 dark:text-white dark:shadow-[4px_4px_0px_0px_#757373]"
              >
                Loading...{" "}
                <BookOpenIcon weight="duotone" className="size-4" />
              </Button>
